...
public class SensitiveContentFilterService {
    ...
    private static final List<Pattern> REFUSAL_PATTERNS = List.of(
            Pattern.compile("(?i)(не могу ответить|не в моих силах|не буду отвечать)"),
            Pattern.compile("(?i)(выходит за (пределы|рамки)|этот вопрос (вне|за пределами))"),
            ...
            Pattern.compile("(?i)(не могу (дать|предоставить) (профессиональн|медицинск|юридическ))")
    );
