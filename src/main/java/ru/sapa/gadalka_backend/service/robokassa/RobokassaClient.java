...
public class RobokassaClient {
     ...
     * <p>
     * ПОДТВЕРЖДЕНО поддержкой Robokassa (31.07.2026): для дочерних (рекуррентных) списаний
     * чек НЕ наследуется автоматически от материнского платежа — Receipt нужно передавать
     * заново в каждом запросе на дочернее списание, иначе чек не будет сформирован вообще
     * (появится ошибка) и его придётся пробивать вручную через приложение «Мой налог».
     * Ниже это уже сделано: Receipt строится и передаётся так же, как для родительского платежа.
     *
